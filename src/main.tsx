...
function renderFatalScreen(message: string) {
 ...
 <h1 style="margin:0 0 12px;font-size:28px">La interfaz encontro un problema</h1>
 <p style="margin:0 0 10px;color:#b9c6cb;line-height:1.7">${message}</p>
 <p style="margin:0;color:#8b989e;line-height:1.7">Cierra y vuelve a abrir la aplicacion. Si vuelve a pasar, esta beta necesita correccion antes de seguir probando en mas equipos.</p>
 </div>
 </div>
 `
}
...
async function prepareDesktopRuntime() {
 ...
 console.warn('No se pudo limpiar la cache local de escritorio:', error)
 }
}
