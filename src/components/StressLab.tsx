...
const copy = {
  es: {
    tests: {
      cpu: { name: 'Procesador', desc: 'Cálculo multinúcleo verificado' },
      gpu: { name: 'Tarjeta gráfica', desc: 'Shaders WebGL 2 de alta carga' },
      memory: { name: 'Memoria RAM', desc: 'Escritura y verificación física' },
    ...
    noSensor: 'Sin sensor',
    inetDesc: 'Mide la velocidad real de tu conexión usando servidores Cloudflare distribuidos globalmente. Requiere conexión a internet activa.',
    ...
    inetPhaseWarmup: 'Calentando conexión…',
    inetPhaseDownload: 'Midiendo descarga…',
    inetPhaseUpload: 'Midiendo subida…',
    inetDone: 'Medición completada',
    inetError: 'Error en la medición',
    inetCancelled: 'Medición cancelada',
    inetReady: 'Listo para medir',
    inetStart: 'Medir velocidad de internet',
    inetStop: 'Cancelar medición',
    inetNote: 'La medición no consume datos significativos (≈ 35 MB) y no estresa el hardware local.',
    chartOf: 'Gráfico de',
    chartWaiting: 'La gráfica aparecerá con las primeras muestras reales.',
    completed: 'Prueba completada',
    thermalCut: 'Corte térmico activado',
    withError: 'Prueba con error',
    stopped: 'Prueba detenida',
    verified: 'verificada',
    integrityErrors: 'con errores',
    peakActivity: 'Actividad máxima',
    peakTemp: 'Temperatura máxima',
    thermalDelta: 'Cambio térmico',
    averagePower: 'Potencia media',
    peakPower: 'Potencia máxima',
    measuredEnergy: 'Energía medida',
    notAvailable: 'No disponible',
    heroEyebrow: 'LABORATORIO DE RENDIMIENTO',
    heroTitle: 'Pruebas de estrés reales',
    ...
    activeLimitsDesc: 'Corte térmico, tiempo e integridad',
    choose: '1 — ELIGE EL COMPONENTE',
    configure: '2 — CONFIGURA LA PRUEBA',
    intensity: 'Intensidad',
    duration: 'Duración',
    tempCut: 'Corte térmico',
    saveWork: 'Guarda tu trabajo. Una prueba de estrés real eleva consumo y temperatura y puede revelar inestabilidad.',
    ...
    memoryNotice: 'La RAM no expone temperatura ni potencia mediante sensores estándar; se muestra sólo actividad real y verificación de memoria.',
    ...
    startedMsg: 'Carga real iniciada. La telemetría se registrará cada segundo.',
