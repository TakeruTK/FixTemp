...
const copy = {
 ...
 quickDone: 'Diagnostico rapido completado',
 quickFailed: 'No fue posible completar todas las pruebas',
 fullDone: 'Evaluacion completa terminada',
 fullFailed: 'La evaluacion completa no pudo finalizar',
 notExported: 'Aun no se ha exportado un informe de pruebas.',
 ready: 'Listo para evaluar',
 evalCpu: 'Evaluando CPU...',
 evalMemory: 'Evaluando memoria...',
 evalGpu: 'Evaluando GPU...',
 preparingFull: 'Preparando la evaluacion completa. El equipo puede ponerse lento.',
 stressingAll: 'Estresando CPU, GPU, memoria y disco en simultaneo...',
 ...
 reportReady: 'Informe exportado: {filename}. El tester ya puede enviarlo al equipo de analisis.',
 quickNote: 'Prueba comparativa rapida ejecutada desde el navegador integrado.',
 fullNote: 'Evaluacion completa terminada sin incidencias adicionales.',
 cpuTimeout: 'La prueba sostenida de CPU no termino a tiempo y se detuvo de forma preventiva.',
 cpuCouldNotRun: 'No se pudo ejecutar la prueba sostenida de CPU.',
 fullNoDisk: 'No habia un volumen disponible para benchmark de disco.',
 fullNoCpuTemp: 'No habia temperatura real reciente para la prueba sostenida de CPU.',
 batteryProtected: 'GPU protegida por el navegador',
 heroEyebrow: 'PC - MOVIL - TABLET',
 heroTitle: 'Rendimiento del dispositivo',
 heroDesc: 'Este panel distingue entre medicion real, cobertura parcial y partes no expuestas por el sistema. La evaluacion completa somete el equipo a carga real para obtener una comparacion mas solida.',
 currentIndex: 'INDICE ACTUAL',
 runningEyebrow: 'EVALUACION EN CURSO',
 runningTitle: 'Se estan estresando varios componentes al mismo tiempo',
 machineSlow: 'El equipo puede ponerse lento',
 important: 'Importante',
 importantDesc: 'Durante este proceso el equipo puede responder mas lento y los ventiladores pueden subir. La duracion cambia segun el hardware, el disco y la disponibilidad de sensores.',
 noThermalSensor: 'sin sensor termico',
 loading: 'cargando',
 diskActive: 'ACTIVO',
 diskOk: 'OK',
 diskBusy: 'lectura y escritura real en curso',
 diskDone: 'benchmark consolidado',
 verify: 'Que se verifica',
 measured: 'Medido',
 limited: 'Limitado',
 unavailable: 'No disponible',
 profile: 'Perfil detectado',
 logicalThreads: 'hilos logicos',
 visibleMemory: 'memoria visible',
 renderer: 'renderizador',
 batteryStorage: 'Bateria y almacenamiento',
 batteryCurrent: 'Bateria actual',
 batteryMissing: 'No presente o no expuesta',
 pluggedIn: 'Conectado a energia',
 ...
 testsDesc: 'Usa el diagnostico rapido para una comparacion local y la evaluacion completa para capturar rendimiento, sensores y almacenamiento con mucha mayor cobertura.',
 quickTest: 'Diagnostico rapido',
 fullTest: 'Evaluacion completa del equipo',
 fullNoteUi: 'La evaluacion completa lanza carga concurrente y puede hacer que el equipo se note mas pesado durante varios segundos.',
 mode: 'MODO',
 full: 'FULL',
 quick: 'RAPIDO',
 ...
 vsBaseline: 'frente a linea base',
 lastFull: 'ultima full',
 comparativeNote: 'Para base de datos comparativa, la muestra mas valiosa es la ultima evaluacion completa, porque indica claramente que partes fueron verificadas y con que cobertura.',
 reportTitle: 'Informe para pruebas',
 reportDesc: 'Exporta el estado del equipo junto con la ultima evaluacion local. Asi la base de datos puede distinguir rendimiento, sensores disponibles y limitaciones del sistema.',
 generating: 'Generando informe...',
 exportFull: 'Exportar informe completo',
 recommend: 'Recomendado: ejecutar primero la evaluacion completa y luego exportar. El informe no inventa datos ausentes.',
 readyToSend: 'Listo para enviar',
 latestFull: 'Ultima evaluacion completa',
 cpuPeak: 'pico CPU',
 gpuPeak: 'pico GPU',
 ...
 batteryMeasured: 'Nivel, ciclos y salud estimada si la bateria lo reporta.',
 ...
 cpuMeasured: 'Carga breve y carga sostenida con telemetria real cuando existe sensor.',
 ...
 reportReady: 'æŠ¥å‘Šå·²å¯¼å‡ºï¼š{filename}ã€‚æµ‹è¯•äººå‘˜çŽ°åœ¨å¯ä»¥å‘e€ç»™åˆ†æžå›¢e˜Ÿã€‚',
 quickNote: 'åœ¨å†…ç½®æµè§ˆå™¨ä¸­æ‰§èŒçš„å«e€Ÿå¯¹æ¯”æµ‹è¯•ã€‚',
 fullNote: 'å®Œæ•´è¯„ä¼°å·²å®Œæˆï¼Œæ²æœ‰e¢å¤–å¼‚å¸¸ã€‚',
 cpuTimeout: 'æŒç»­ CPU æµ‹è¯•æœªèƒ½æŒ‰æ—¶ç»“æŸï¼Œå·²å‡ºäºŽäæŠ¤ç›®çš„åœæ­¢ã€‚',
 cpuCouldNotRun: 'æ— æ³•æ‰§èŒæŒç»­ CPU æµ‹è¯•ã€‚',
 ...
 heroEyebrow: 'PC - æ‰‹æœº - å¹³æ',
 heroTitle: 'è®¾å¤‡æ€§èƒ½',
 heroDesc: 'æ­¤e¢æä¼šåŒºåˆ†çœŸå®žæµ‹e‡ã€eƒ¨åˆ†è¦†ç›–ä»¥åŠç³»ç»Ÿæœªæš´eœ²çš„eƒ¨åˆ†ã€‚å®Œæ•´è¯„ä¼°ä¼šå¯¹è®¾å¤‡æ–½åŠ çœŸå®žè´Ÿè½½ï¼Œä»¥èŽ·å¾—æ›´å¯e çš„å¯¹æ¯”ç»“æžœã€‚',
 currentIndex: 'å½“å‰æŒ‡æ•°',
 runningEyebrow: 'è¯„ä¼°è›èŒä¸­',
 runningTitle: 'å¤šä¸ªç»„ä»¶æ­£åœ¨åŒæ—¶å—åŽ‹',
 machineSlow: 'è®¾å¤‡å¯èƒ½ä¼šå˜æ…¢',
 important: 'e‡è¦',
 importantDesc: 'åœ¨æ­¤è‡ç¨‹ä¸­ï¼Œè®¾å¤‡å“åº”å¯èƒ½ä¼šå˜æ…¢ï¼Œe£Žæ‰‡ä¹Ÿå¯èƒ½å‡e€Ÿã€‚è€—æ—¶å–å†³äºŽç¬ä»¶ã€ç£ç›˜å’Œä¼ æ„Ÿå™¨å¯ç”¨æ€§ã€‚',
 noThermalSensor: 'æ— æ¸©åº¦ä¼ æ„Ÿå™¨',
 loading: 'åŠ è½½ä¸­',
 diskActive: 'èèŒä¸­',
 diskOk: 'å®Œæˆ',
 diskBusy: 'çœŸå®žè¯»å†™è›èŒä¸­',
 diskDone: 'åŸºå‡†ç»“æžœå·²æ±‡æ€»',
 verify: 'eªŒè¯å†…å®¹',
 measured: 'å·²æµ‹e‡',
 limited: 'å—e™',
 unavailable: 'ä¸å¯ç”¨',
 profile: 'æ£€æµ‹åˆ°çš„e…ç½®',
 logicalThreads: 'e€»è¾‘çºç¨‹',
 visibleMemory: 'å¯è§å†…å­˜',
 renderer: 'æ¸²æŸ“å™¨',
 batteryStorage: 'ç”µæ± ä¸Žå­˜å‚¨',
 batteryCurrent: 'å½“å‰ç”µæ± ',
 batteryMissing: 'ä¸å­˜åœ¨æˆ–æœªæš´eœ²',
 pluggedIn: 'å·²æŽ¥e€šç”µæº',
 discharging: 'æ”¾ç”µä¸­',
 noReading: 'æ— å¯ç”¨è¯»æ•°',
 cycles: 'å¾ªçŽ¯',
 storageUsed: 'å·²ç”¨å­˜å‚¨',
 restricted: 'å—e™',
 browserNoCapacity: 'æµè§ˆå™¨æœªæš´eœ²å®¹e‡äæ¯',
 testsAvailable: 'å¯ç”¨æµ‹è¯•',
 testsDesc: 'å«e€Ÿè¯Šæ–­ç”¨äºŽæœ¬åœ°å¯¹æ¯”ï¼›å®Œæ•´è¯„ä¼°åˆ™èƒ½ä»¥æ›´e«˜è¦†ç›–çŽ‡æ•èŽ·æ€§èƒ½ã€ä¼ æ„Ÿå™¨ä¸Žå­˜å‚¨è¨çŽ°ã€‚',
 quickTest: 'å«e€Ÿè¯Šæ–­',
 fullTest: 'å®Œæ•´è®¾å¤‡è¯„ä¼°',
 fullNoteUi: 'å®Œæ•´è¯„ä¼°ä¼šå¯åŠ¨å¹¶å‘è´Ÿè½½ï¼Œè®¾å¤‡åœ¨æ•°ç§’å†…å¯èƒ½æ˜Žæ˜¾å˜e‡ã€‚',
 mode: 'æ¨å¼',
 full: 'å®Œæ•´',
 quick: 'å«e€Ÿ',
 coverage: 'è¦†ç›–çŽ‡',
 ...
 comparativeNote: 'å¯¹äºŽå¯¹æ¯”æ•°æ®åº“è€Œè¨€ï¼Œæœ€æœ‰ä»·å€¼çš„æ ·æœ¬æ˜¯æœ€è‘ä¸€æ¬å®Œæ•´è¯„ä¼°ï¼Œå› ä¸ºå®ƒèƒ½æ¸…æ¥šè¯´æ˜Žå“ªäº›eƒ¨åˆ†å·²è¢«eªŒè¯ä»¥åŠè¦†ç›–çŽ‡å¦‚ä½•ã€‚',
 reportTitle: 'æµ‹è¯•æŠ¥å‘Š',
 reportDesc: 'å¯¼å‡ºè®¾å¤‡çŠ¶æ€ä»¥åŠæœ€è‘ä¸€æ¬æœ¬åœ°è¯„ä¼°ã€‚è™æ ·æ•°æ®åº“å°±èƒ½åŒºåˆ†æ€§èƒ½ã€å¯ç”¨ä¼ æ„Ÿå™¨å’Œç³»ç»Ÿe™åˆ¶ã€‚',
 generating: 'æ­£åœ¨ç”ŸæˆæŠ¥å‘Š...',
 exportFull: 'å¯¼å‡ºå®Œæ•´æŠ¥å‘Š',
 recommend: 'å»ºè®®å…ˆæ‰§èŒå®Œæ•´è¯„ä¼°ï¼Œå†å¯¼å‡ºæŠ¥å‘Šã€‚æŠ¥å‘Šä¸ä¼šè™šæž„ç¼ºå¤±æ•°æ®ã€‚',
 readyToSend: 'å¯å‘e€',
 ...
 serviceNote: 'ç”±æœåŠæœ¬èº«æµ‹å¾—ï¼›ä¸åŒ…å« Chromium çª—å£ã€‚',
 batteryMeasured: 'å¦‚æžœç”µæ± æä¾›æ•°æ®ï¼Œåˆ™æ˜¾ç¤ºç”µe‡ã€å¾ªçŽ¯æ¬æ•°ä¸Žä¼°ç®—å¥åº·åº¦ã€‚',
 batteryUnavailable: 'ä¸e€‚ç”¨æˆ–ç³»ç»Ÿæœªæš´eœ²ã€‚',
 diskMeasured: 'å¯¹æœ¬åœ°å·è›èŒçœŸå®žè¯»å†™ã€‚',
 diskUnavailable: 'æ²æœ‰å¯ç”¨äºŽåŸºå‡†æµ‹è¯•çš„å·ã€‚',
 cpuMeasured: 'å½“å­˜åœ¨ä¼ æ„Ÿå™¨æ—¶ï¼Œè›èŒçŸ­è´Ÿè½½ä¸ŽæŒç»­è´Ÿè½½å¹¶è®°å½•çœŸå®že¥æµ‹ã€‚',
 gpuMeasured: 'ä½ç”¨ WebGL 2 è›èŒæ¸²æŸ“ï¼Œåœ¨ç³»ç»Ÿå…è®¸æ—¶è®°å½•çœŸå®ž FPSã€æ¸©åº¦ä¸ŽåŠŸè€—ã€‚',
 memoryMeasured: 'ç”¨æˆ·å¯è§çš„æŒç»­å†…å­˜æ´»åŠ¨ã€‚',
 browserQuickName: 'device',
 testRequiredNote: 'å®Œæˆå®Œæ•´è¯„ä¼°åŽå³å¯è§£e”æŠ¥å‘Šå¹¶å‚ä¸ŽæŽ’åã€‚',
 rankSending: 'æ­£åœ¨æäº¤åˆ°å…¨çƒæŽ’å...',
 rankSent: 'å·²åŠ å…¥æŽ’å!',
...
async function gpuBenchmark(durationMs = 1800, intensive = false): Promise<number | null> {
 ...
 // Intensive: 224 iteraciones a 1280x720 (mismo shader que GpuStressEngine - estresa la GPU real)
 // Quick: 90 iteraciones a 640x360 (medicion comparativa ligera)
...
async function memoryBenchmark() {
 // Buffer 128 MB - supera la cache L3 de cualquier CPU actual.
 // Acceso secuencial completo (i++) en lugar de stride-32, lo que obliga a acceder a RAM fisica.
 // Metrica de salida: MB/s de ancho de banda de lectura+escritura real.
