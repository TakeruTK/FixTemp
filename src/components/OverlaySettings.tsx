...
const copy = {
  es: {
    ...
    fpsInfo: 'FixTemp no inventa FPS: quedará “—” hasta conectar un proveedor de cuadros compatible. Uso, VRAM, temperaturas y watts sí provienen de los sensores actuales.',
    noData: '—',
    cpu: 'Uso de CPU',
  ...
  'zh-CN': {
    ...
    fpsInfo: 'FixTemp 不会虚构 FPS：在连接兼容的帧率提供程序之前会显示为 “—”。使用率、VRAM、温度和功耗来自当前传感器。',
    noData: '—',
    cpu: 'CPU 使用率',
    cpuDetail: '处理器总负载',
    gpu: 'GPU 使用率',
