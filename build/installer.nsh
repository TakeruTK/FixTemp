...
Function StartupOptionsCreate
 ...
 Abort
 ${EndIf}
 ${NSD_CreateLabel} 0 0 100% 28u "Puedes iniciar FixTemp automaticamente al ingresar a Windows o abrirlo manualmente desde el menu Inicio."
 Pop $0
 ${NSD_CreateCheckbox} 0 40u 100% 14u "Iniciar FixTemp al iniciar sesion en Windows"
