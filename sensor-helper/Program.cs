...
static class Program
{
 ...
 var temperatureSource = packageTemp?.Name ?? (temperatures.Count > 0 ? "M-ximo de n-cleos" : null);
 ...
 clockSource = hardwareClocks.Count > 0 ? "LibreHardwareMonitor - n-cleos" :
